...
const handleSubmit = (e: React.FormEvent) => {
  ...
  // If editing → send JSON with URLs, not FormData
  if (editingProduct) {
    const productData = {
      name,
      slug,
    ...
    console.log("✅ Submitted (Edit) Data:", productData);
    return;
  }

  // If creating → still need FormData for file uploads
  ...
  console.log("✅ Submitted (Create) FormData:", {
    name,
    slug,
    description,
    price,
